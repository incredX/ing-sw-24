...
public class GameMessages {
    public static final String NOT_NORMAL_TURN = "Not normal turn";
    public static final String NOT_FINAL_TURN = "Not final turn";
    public static final String CANT_DRAW_FROM_NORMAL_DECK_IS_EMPTY = "Normal Deck is empty";
    public static final String CANT_DRAW_FROM_GOLDEN_DECK_IS_EMPTY = "Golden Deck is empty";
    public static final String INDEX_DECK_WRONG = "Index not available";
    ...
    public static final String GAME_ENDED = "Can't play anymore";
    public static final String GOAL_PHASE_COMPLETED = "CHOOSE GOAL PHASE COMPLETED, READY TO GO";
}
